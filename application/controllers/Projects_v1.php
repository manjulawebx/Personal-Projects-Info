...
class Projects extends CI_Controller {
	...
	public function __construct()
    {
            ...
            $this->project = new Projects_model();
    }
	...
	public function add($id=-1){
         ...
         */
	/*
        public function convert_project($id=-1){
            $project_obj = new Projects_model();
            $project_obj->id = $id;
            $project_obj->load();
            
            //Convert
//            echo "Admin PW:".$this->encrypt->decode($project_obj->prj_prod_admin_pw)."<br>";
            $project_obj->prj_prod_admin_pw    = $this->encryption->encrypt($this->encrypt->decode($project_obj->prj_prod_admin_pw));
//            echo "Converted Encrypted Admin PW:".$project_obj->prj_prod_admin_pw."<br>";
//            echo "Converted Decrypted Admin PW:".$this->encryption->decrypt($project_obj->prj_prod_admin_pw)."<br>";
            
//            echo "prj_testing_admin_pw".$this->encrypt->decode($project_obj->prj_testing_admin_pw)."<br>";
            $project_obj->prj_testing_admin_pw = $this->encryption->encrypt($this->encrypt->decode($project_obj->prj_testing_admin_pw));
//            echo "Converted Decrypted prj_testing_admin_pw PW:".$this->encryption->decrypt($project_obj->prj_testing_admin_pw)."<br>";
            
//            echo "prj_host_pw:".$this->encrypt->decode($project_obj->prj_host_pw)."<br>";
            $project_obj->prj_host_pw          = $this->encryption->encrypt($this->encrypt->decode($project_obj->prj_host_pw));
            
//            echo "prj_ftp_pw:".$this->encrypt->decode($project_obj->prj_ftp_pw)."<br>";
            $project_obj->prj_ftp_pw           = $this->encryption->encrypt($this->encrypt->decode($project_obj->prj_ftp_pw));
            $project_obj->save();
        ...
        public function convert_all(){
            $project_obj = new Projects_model();
            $project_obj->load();
            $projects_all = $project_obj->all();   
            foreach($projects_all as $prj){
                $this->convert_project($prj->id);
                echo $prj->id." Converted.<br>";
            }
        }
        */
